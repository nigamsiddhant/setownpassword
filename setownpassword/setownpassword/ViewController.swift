...
//  Copyright © 2018 Siddhant Nigam. All rights reserved.
//
...
//        print("ans\(ans)")
    ...
    @IBAction func go(_ sender: Any) {
        ...
        if ans == password
        {
            ...
            let vc : resultpage = sb.instantiateViewController(withIdentifier: "resultpage") as! resultpage
        ...
        else
        {
            ...
            let alert = UIAlertController.init(title: "Error", message: "Inncorect Password", preferredStyle: .alert)
